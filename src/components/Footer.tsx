    ...
    <footer className="bg-foreground text-background/70 py-12">
      <div className="container mx-auto px-6 max-w-5xl">
        <div className="grid sm:grid-cols-3 gap-8 mb-8">
          <div>
            <h4 className="font-display text-background text-lg font-bold mb-3">AI 出書實戰班</h4>
            <p className="font-body text-sm leading-relaxed">
              出書作者陪跑 × AI 輔助 × 出版社資深總編審閱
            </p>
          </div>
          <div>
            <h4 className="font-body text-background text-sm font-bold mb-3">快速連結</h4>
          ...
          <div>
            <h4 className="font-body text-background text-sm font-bold mb-3">聯繫我們</h4>
            <ul className="space-y-2 font-body text-sm">
              <li>
        ...
        <div className="border-t border-background/10 pt-6 font-body text-xs text-background/40 flex flex-wrap justify-between gap-4">
