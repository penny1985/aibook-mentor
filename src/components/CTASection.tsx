    ...
    <section className="relative bg-surface-dark text-surface-dark-foreground py-20 md:py-28 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-6 max-w-4xl text-center">
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <p className="font-body text-surface-dark-foreground/70 text-base leading-relaxed mb-4">
            出版社越來越保守，本土作者的空間正在被壓縮。但讀者還在，市場的結構正在重新洗牌。
          </p>
          <p className="font-body text-surface-dark-foreground/70 text-base leading-relaxed">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12 font-body text-base">
          <span className="border border-accent-gold text-accent-gold px-4 py-2">4/11（五）台中</span>
          <span className="border border-accent-gold text-accent-gold px-4 py-2">4/12（六）高雄</span>
        ...
        <div className="grid sm:grid-cols-2 gap-8 max-w-2xl mx-auto mb-16">
          <div>
            <p className="font-body text-surface-dark-foreground/50 text-base mb-3">👉 台中場 4/11</p>
            <div className="flex flex-col gap-3">
              ...
              <a href="https://cart.cashier.ecpay.com.tw/qp/z5Z9" target="_blank" rel="noopener noreferrer"
                className="block border border-surface-dark-foreground/30 text-surface-dark-foreground hover:border-accent-gold hover:text-accent-gold font-body text-base px-6 py-4 rounded transition-colors text-center">
                一日工作坊 NT$7,500
              </a>
            </div>
          </div>
          <div>
            <p className="font-body text-surface-dark-foreground/50 text-base mb-3">👉 高雄場 4/12</p>
            <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap justify-center gap-4 text-surface-dark-foreground/40 font-body text-sm tracking-widest">
          <span>台中 ＆ 高雄</span>
        ...
        <div className="mt-20 border-t border-surface-dark-foreground/10 pt-12 text-left max-w-2xl mx-auto">
          <h3 className="font-display text-xl font-bold mb-6">課程資訊</h3>
          <div className="grid sm:grid-cols-2 gap-4 font-body text-base text-surface-dark-foreground/60">
            <div>
          ...
          <div className="flex gap-4 mt-6">
            <a href="https://www.facebook.com/peiru1985" target="_blank" rel="noopener noreferrer"
              className="font-body text-surface-dark-foreground/50 text-base underline hover:text-accent-gold transition-colors">
              追蹤陳沛孺
            </a>
