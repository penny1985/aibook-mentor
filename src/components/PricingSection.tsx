    ...
    <section className="bg-background py-20 md:py-28">
      <div className="container mx-auto px-6 max-w-5xl">
        ...
        <div className="border-l-4 border-accent-gold pl-8">
          <h3 className="font-display text-xl font-bold text-foreground mb-4">報名即贈：AI 出書工具包</h3>
          ...
          <p className="font-body text-muted-foreground/60 text-sm mt-4">工具包在課前寄出，你可以先熟悉流程，上課當天直接進入實作。</p>
        </div>
      </div>
    </section>
  );
